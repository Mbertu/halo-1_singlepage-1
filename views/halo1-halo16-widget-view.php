<?php
    ...
    class Halo1Halo16WidgetView extends Halo1AbstractFrontendView
    {
        private $args;
        private $widget;
        private $plugin;
        ...
        public function renderContent($args = null)
        {
            $this->args = $args;
            $this->widget = $args['widget'];
            $this->plugin = $args['plugin'];

			$this->align = get_theme_mod('halo16_center') == true ? 'col-sm-height col-sm-middle' : '';
        ...
        {
            ?>
        		<div class="col-xs-12 <?php echo $behavior; ?> <?php echo $this->align; ?>  wow <?php echo $animation; ?>"
        			...
        			<div class="halo16_content" style="color:<?php echo $this->colors['text']; ?>;">
        				<?php echo apply_filters('the_content', $this->args['content']); ?>
        			</div>
