 ...
 */
class Halo1CategoryView extends Halo1AbstractFrontendView {
    ...
    public function renderContent($args){
        ...
        ?>
            <div class="col-xs-12 col-md-9">
                    ...
                    <?php if(!empty($data['category_content'])){?>
                        <div class="row">
                            <div class="col-xs-12">
                                <p class="description"><?php echo $data['category_content'];?></p>
                            </div>
                        </div>
                    <?php } ?>
                    <div class="row">
                    <?php if(count($data['posts_list']) == 0){ ?>
                        <div class="col-xs-12">
                            <?php echo $data['empty_category_message']; ?>
                        </div>
                    <?php }
